package com.valeo.loyalty.android.view;
...
public class CenterDrawableButton extends AppCompatButton {
    ...
    public CenterDrawableButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (drawables[LEFT] != null) {
            ...
            drawableBounds.offsetTo(leftOffset, 0);
        ...
        if (drawables[RIGHT] != null) {
            ...
            drawableBounds.offsetTo(rightOffset, 0);
